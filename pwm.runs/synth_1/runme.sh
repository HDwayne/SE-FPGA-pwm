...
HD_PWD='C:/Users/hdway/Documents/vivado/pwm/pwm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm.tcl
